...
class ValidationFiles(NamedTuple):
    """Container for all the files that are generated by the validation routine"""

    plot_path: Path
    """Path to the validation plot"""
    psf_table_path: Path
    """Path to the PSF table"""
    stats_table_path: Path
    """Path to the statistics table"""
    nvss_xmatch_table_path: Path
    """Path to the NVSS cross match table"""
    sumss_xmatch_table_path: Path
    """Path to the SUMSS cross match table"""
    racs_high_xmatch_table_path: Path
    """Path to the RACS high cross match table"""
    racs_mid_xmatch_table_path: Path
    """Path to the RACS mid cross match table"""
    tgss_xmatch_table_path: Path
    """Path to the TGSS cross match table"""
    vlass_xmatch_table_path: Path
    """Path to the VLASS cross match table"""
    icrf_xmatch_table_path: Path
    """Path to the ICRF cross match table"""
